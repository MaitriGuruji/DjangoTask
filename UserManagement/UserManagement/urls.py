...
urlpatterns = [
                  ...
                  path('logout/', v.logout_page),
                  path('edit_profile/', v.edit_profile_page),
                  path('password/', v.change_password_request),
                  path('dashboard/', v.dashboard_page),
